...
#include "HICEShared.h"
#include "HICEHandle.h"
#include "HICEMutex.h"
...
public:
    ...
    // was created using the HICEUtil::Thread class must either be
...
class HUTIL_API Thread : virtual public HICEUtil::Shared
{
public:
