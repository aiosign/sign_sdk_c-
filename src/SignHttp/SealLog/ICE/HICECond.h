...
#ifdef _WIN32
    HUTIL_API void wake(bool);
    HUTIL_API void preWait() const;
    HUTIL_API void postWait(bool) const;
    HUTIL_API bool timedDowait(const Time&) const;
    HUTIL_API void dowait() const;
